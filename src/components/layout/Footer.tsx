          ...
          <div className="flex items-center gap-4">
            ...
            >
              <svg
                ...
                aria-hidden="true"
              >
                <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.847h-7.406l-5.8-7.584-6.64 7.584H.474l8.6-9.83L0 1.153h7.594l5.243 6.932L18.901 1.153zm-1.29 19.494h2.04L6.486 3.24H4.298l13.313 17.407z" />
              </svg>
            </a>
          </div>
        </div>
